...
public class FXMLGraph1Controller implements Initializable {
    ...
    private void loadData(ActionEvent event) {
        try {
            ...
            PreparedStatement ps = con.prepareStatement("Select count(sno),bgroup from blood where rdate between '" + dFdate.getValue() + "' and '" + dTdate.getValue() + "' group by bgroup");
